...
export const ENERGY_DRAIN = 0.0175;
...
export const LASER_DAMAGE = 2.0;            // per second, bypasses shield + invincibility
export const REACTOR_CONTACT_DAMAGE = 2.0; // per second, bypasses shield + invincibility
